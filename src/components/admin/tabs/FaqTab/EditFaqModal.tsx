...
import { useUpdateFaq } from "@/hooks/admin/use-admin-faq";
...
export function EditFaqModal({ faq, onClose }: EditFaqModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMsg = err instanceof Error ? err.message : "فشل تحديث السؤال";
      toast.error("فشل تحديث السؤال", { description: errorMsg });
    }
  };
